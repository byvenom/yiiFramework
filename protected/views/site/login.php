                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form id="user" class="user" method="POST" action="/site/login_ok">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" name="userid"
                                                id="exampleUserid" aria-describedby="emailHelp"
                                                placeholder="Id">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <a href="#" class="btn btn-primary btn-user btn-block" onclick="return login_ok()">
                                            Login
                                        </a>
                                        <hr>
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="/site/register">Create an Account!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
