...
function favoriteAdd(userid,corp,stock){
	$.ajax({
		url:"/jusik/favoriteAdd",
		data:{"userid":userid,"corp_code":corp,"stock_code":stock},
		type: "post",
		async : false,
...
<head>
    ...
    <link href="/css/sb-admin-2.min.css?var=4" rel="stylesheet">
	<style>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"><?=$str?> Search</h1>
                    ...
                    <div class="row">
						...
						<? if($chk){ ?>
						<table class="table myTable headerH">
							<tr>
								<th>Company</th>
								<th width="">Corp_code</th>
								<th width="">Stock_code</th>
								<th>Favorite</th>
							</tr>
							<? echo $data; ?>
                        </table>
